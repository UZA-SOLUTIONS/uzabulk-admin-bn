...
router.post('/', Auth.authAdminAndStaffAndVendor, Auth.checkAccessLevel, catController.CategoryMiddleware);
//Add Category
router.post('/add', Auth.authAdminAndStaffAndVendor, Auth.checkAccessLevel, catController.CategoryMiddleware);
//update category
...
router.get('/listByLevel', Auth.authAdminAndStaffAndVendor, catController.categoryListByLevel);
