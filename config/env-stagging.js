const env = {
    ...
    "socketUrl": process.env.SOCKET_URL || "https://staging-admin-api.uzabulk.com",
    "pay360BaseUrl": "https://secure.test.pay360evolve.com/api/v1/merchants/",
    "socketIp": "18.216.189.191",
    "socketUrlApi": process.env.SOCKET_URL_API || "https://staging-admin-api.uzabulk.com/authenticationservice/api/v1/store",
