...
const addSlipField = (label, value) => {
    return `<tr>
...
module.exports.pdfproductTemplate = () => {
    return `
        <tr>
            ...
            <h4 style="margin: 0;color: #74788d;font-weight: 500;font-size: 12px;">[currency] [productCost] x [productQuantity]<strong style="margin-left: 30px;">= [currency][productSubtotal]</strong></h4>
            </td>
        </tr>`
}
            ...
            <tr>
                ...
                <td style="vertical-align: text-bottom">
                    <table style="width: 100%">
                        ...
                        <tbody>
                            ${addSlipField("Name", "billingName")}
                            ${addSlipField("Mobile number", "billingMobileNumber")}
                            ${addSlipField("Area", "billingArea")}
                            ${addSlipField("House No", "billingHouseNo")}
                            ${addSlipField("Address", "billingAddress")}
                            ${addSlipField("Landmark", "billingLandmark")}
                            ${addSlipField("Address Type", "billingAddressType")}
                        </tbody>
                    </table>
                </td>
            </tr>
            ...
            <tr>
                <td style="vertical-align: text-bottom">
                  ...
                  ">
                        ...
                        <tbody>
                            ${addSlipField("Name", "shippingName")}
                            ${addSlipField("Mobile number", "shippingMobileNumber")}
                            ${addSlipField("Area", "shippingArea")}
                            ${addSlipField("House No", "shippingHouseNo")}
                            ${addSlipField("Address", "shippingAddress")}
                            ${addSlipField("Landmark", "shippingLandmark")}
                            ${addSlipField("Address Type", "shippingAddressType")}
                        </tbody>
                    </table>
                </td>
            </tr>
