...
/** Admin list: paginated parents with nested subcategories (max 3 levels), sorted. */
module.exports.uzaCategories = function (obj, sortByField, sortOrder, paged, pageSize, callback) {
...
module.exports.countCategories = function (obj) {
    return categoryTable.countDocuments(obj);
}
...
module.exports.getExternalCategory = (categoryIds) => {
    return categoryTable.find({ externalCatId: { $in: categoryIds }, status: "active" });
}